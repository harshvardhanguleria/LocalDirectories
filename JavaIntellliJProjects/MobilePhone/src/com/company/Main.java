...
public class Main {
    ...
    private static void updateContact() {
        ...
        Contact newContact = Contact.createContact(newName,
                newNumber);
        if (mobilePhone.updateContact(existingContactRecord,
                newContact)) {
    ...
    private static void queryContact() {
        ...
        System.out.println("Name: "+
                existingContactRecord.getName() +" phone number"+
                " is "+ existingContactRecord.getPhoneNumber());
    }
    ...
    private static void printActions() {
        ...
        System.out.println("0 - to shutdown\n"+
                ...
                "5 - query is an existing contact exists\n"+
